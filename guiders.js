...
(function($) {
  ...
  guiders._attach = function(myGuider) {
    ...
    if (myGuider.containerSelector) {
      containerOffset = $(myGuider.containerSelector).offset();
  ...
  guiders._completeShow = function(myGuider, id){
  ...
  guiders.createGuider = function(passedSettings) {
    ...
    guiderElement.hide();
    guiderElement.appendTo(passedSettings.containerSelector || "body");
  ...
  guiders.show = function(id) {
    ...
    if (myGuider.onShow) {
      myGuider.onShow(myGuider, function() {
        return self._completeShow(myGuider, id);
      });
    } else {
      return this._completeShow(myGuider, id);
    }
  };
